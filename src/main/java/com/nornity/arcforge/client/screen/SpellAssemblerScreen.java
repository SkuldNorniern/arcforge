...
public class SpellAssemblerScreen extends AbstractContainerScreen<SpellAssemblerMenu> {
    ...
    public SpellAssemblerScreen(SpellAssemblerMenu menu, Inventory inventory, Component title) {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, xo, yo, 0.0F, 0.0F, this.imageWidth, this.imageHeight, this.imageWidth, this.imageHeight);
    }
}
